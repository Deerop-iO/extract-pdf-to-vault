...
Paste this into a Cursor chat to brief the agent, or just run one of the
`/p2v-*` slash commands. Tools that auto-scan for `AGENTS.md` (Codex) or
`CLAUDE.md` (Claude Code) will pick up the charter automatically.
